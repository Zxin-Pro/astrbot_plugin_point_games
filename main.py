...
# 钓鱼随机事件表：(事件名, 概率%)，按顺序累计判定，总和恰为 100（v4.22.20 扩容 49 事件）
...
class PointGamesPlugin(Star):
    ...
    async def _fishing_check(self):
        ...
        # 渲染器已内联进 main.py（single-file 可持续出图，无需补充 fishing_poster.py）
        render_fishing_batch = render_fishing_batch
